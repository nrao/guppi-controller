...
from bee2_server import Bee2Server

def Bee2Client(agent_class = None):
    """Creates a client for the BEE2.

    Keyword arguments:
    agent_class -- class running as the server's agent
    """
    return make_service_client('http://bee2:8915',
                               Bee2Server(agent_class))
